...
parser.addArgument(['-p', '--port'], {action: 'store', dest: 'port', defaultValue: 9000, help: 'the port to connect to on the server. Can be defined on the server arg via server:port'});
